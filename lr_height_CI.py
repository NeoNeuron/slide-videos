...
ax.set_ylabel('女孩身高(cm)', fontsize=30)
ax.set_ylim([150,220])
ax.set_xlim([155,210]) 
...
def CI(x, b0, b1):
	...
	text1 = ax.text(156,b1*x+b0+width+0.3, f'{b1*x+b0+width:.0f}', fontsize=12, ha='left', va='bottom', color='r', alpha=0.8)
	text2 = ax.text(156,b1*x+b0-width-0.4, f'{b1*x+b0-width:.0f}', fontsize=12, ha='left', va='top', color='r', alpha=0.8)
